...
// imporrt components
import PlaneListRow from './PlaneListRow';

import { Offcanvas } from '../../../portals/Offcanvas';
import {useModal} from '../../../providers/ModalProvider';
import AddPlaneModal from '../../components/modal/AddPlaneModal';
        ...
        <div>
            ...
            <div className="row d-flex align-items-center">
                <div className="col-md-6">
                    <h5 className="title">{t('Airplanes')}</h5>
                </div>
            ...
            {/* offcanvas */}
            <Offcanvas isOpen={isModal2Open} title="Add Plane" handleClose={closeModal2}>
                <AddPlaneModal />
            </Offcanvas>
