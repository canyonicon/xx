...
const EmployeeList = () => {
    ...
    return (
        <div>
                        ...
                        <div className="d-flex gap-1 align-items-center">
                            ...
                            <div className="dropdown filter">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a className="dropdown-item" href="#">{t('All')}</a></li>
                                    <li><a className="dropdown-item" href="#">{t('Active')}</a></li>
                                    <li><a className="dropdown-item" href="#">{t('Inactive')}</a></li>
                                </ul>
                            </div>
                            ...
                            <div className="dropdown sort">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a className="dropdown-item" href="#">{t('None')}</a></li>
                                    <li><a className="dropdown-item" href="#">{t('ASC')}</a></li>
                                    <li><a className="dropdown-item" href="#">{t('DESC')}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <tr>
                            <th scope="col">
                                <div className="form-check">
                                    <input className="form-check-input" name="" id="" type="checkbox" value="checkedValue" aria-label="Checkbox" />
                                </div>
                            </th>
            ...
            {/* offcanvas */}
            <Offcanvas isOpen={isModal2Open} title='New Employee' handleClose={closeModal2} width="w-50">
                <AddEmployeeModal />
            </Offcanvas>
        </div>
    );
