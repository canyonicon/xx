...
import AddAirportModal from '../../components/modal/AddAirportModal';
        ...
        <div>
            ...
            <div className="row d-flex align-items-center">
                <div className="col-md-6">
                    <h5 className="title">{t('Airports')}</h5>
                </div>
                ...
                <table className="table align-middle table-hover mb-0">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Airport Number</th>
            ...
            {/* offcanvas */}
            <Offcanvas isOpen={isModal2Open} title='New Airport' handleClose={closeModal2} width="w-50">
                <AddAirportModal />
            </Offcanvas>
        </div>
    );
